...
<form  wire:submit.prevent="update"   enctype="multipart/form-data" name="produtoform" id="produtoform" >
        ...
        <div class="row mx-5">
                        ...
                        <div class="input-group w-auto p-3" >
                            ...
                            <select   wire:model.lazy="produto_id"  wire:change="atualizadados" class="form-select" id="produto_id" name="produto_id" >
                         ...
                         <div class="input-group w-auto p-3">
                            ...
                            <input  type="number"  wire:model="qtd" wire:change="atualizadados"  value="1" min="1" step="1" data-number-to-fixed="1" data-number-stepfactor="100" class="form-control" id="c2" />
                        </div>
                        <div class="input-group w-auto p-3">
                        ...
                        <div class="input-group w-auto p-3">
                            ...
                            <input  type="number"  wire:model="total" value="1000" min="0" step="0.01" data-number-to-fixed="2" data-number-stepfactor="100" class="form-control currency" id="c2" />
                        </div>
