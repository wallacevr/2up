<div>
    <form  wire:submit.prevent="store"   enctype="multipart/form-data" name="usuarioform" id="usuarioform" >
    @if (!$errors->isEmpty())
    ...
    <div class="row mx-5">
        ...
        <div class="row mx-5">
                <div class="input-group mb-3 col-sm" >
                    ...
                    <input type="password" wire:model.lazy="password" name="senha" class="form-control" placeholder="Senha" aria-label="Senha" aria-describedby="basic-addon1">
                </div>
                <div class="input-group mb-3 col-4" >
                    <span class="input-group-text" id="basic-addon1">Confirmação:</span>
                    <input type="password" wire:model.lazy="password_confirmation" name="password_confirmation" class="form-control" placeholder="Confirmação" aria-label="Confirmação" aria-describedby="basic-addon1">
                </div>
